    ...
    public boolean handle(int interfaceId, int buttonId){
        ...
        switch(stage){
            ...
            case 7:
                ...
                break;
            case 8:
                npc("I offer two different types of kebabs: the standard","run-of-the-mill kebab seen throughout RBGScape and","enjoyed by many a intoxicated dwarf, and my specialty,","the extra-hot kebab. So which shall it be?");
                stage = 9;
                break;
            case 9:
