						...
						if(60 == RSString.incomingOpcode) {
							...
							if(RSString.incomingOpcode == 115) {
								...
								if(RSString.incomingOpcode == 70) {
									...
									if(var70.method1550((byte) -60, Class117.aClass94_1614)) {
									...
									} else if (var70.method1550((byte) -47, Class30.aClass94_567)) {
									...
									} else if (var70.method1550((byte) -98, Class3_Sub13_Sub26.aClass94_3330)) {
										var31 = false;
										...
										} else if (var70.method1550((byte) -41, ISAACCipher.aClass94_965)) {
										...
										} else if (var70.method1550((byte) -110, Class3_Sub13_Sub30.aClass94_3368)) {
												...
												while (true) {
													...
													if (1 >= clanChatIcon) {
														for (var54 = 0; var54 < Class3_Sub28_Sub5.anInt3591; ++var54) {
															if (var2 == Class114.aLongArray1574[var54]) {
																var63 = true;
																break label1521;
															}
														}
																...
																if (modelId >> 30 == 0) {
																	...
																	if (modelId >> 29 != 0) {
																		...
																		if (null != var62) {
																			...
																			var32 = true;
																			if (0 != ~counter && -1 != var62.anInt2842 && Client.getAnimationDefinition(RenderAnimationDefinition.getGraphicDefinition((byte) 42, var62.anInt2842).anInt542, (byte) -20).anInt1857 > Client.getAnimationDefinition(RenderAnimationDefinition.getGraphicDefinition((byte) 42, counter).anInt542, (byte) -20).anInt1857) {
																				var32 = false;
																			}
			...
			if(Class21.aBoolean440 && Class85.aBoolean1167) {
				...
				if(0 == Class3_Sub13_Sub5.anInt3069) {
					if(NPC.aBoolean3975) {
						...
						} else {// && client.method42(Class56.aClass11_886) != null) {
