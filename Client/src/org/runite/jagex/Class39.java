	...
	static final void updateSceneGraph(int var0, boolean dynamic) {
		try {
			...
			if(Class3_Sub29.isDynamicSceneGraph) {
				...
				GraphicDefinition.incomingBuffer.method818(false);//false
				...
				if(RSString.incomingOpcode == 121) {
					...
					if(RSString.incomingOpcode == 14) {
						...
						if(16 == RSString.incomingOpcode) {
							...
							if (var2 >= 0 && var3 >= 0 && var2 < 104 && var3 < 104) {
								var28 = 1 + var6;
								if (var2 + -var28 <= Class102.player.anIntArray2767[0] && Class102.player.anIntArray2767[0] <= var28 + var2 && Class102.player.anIntArray2755[0] >= -var28 + var3 && Class102.player.anIntArray2755[0] <= var28 + var3 && 0 != Class14.anInt340 && var7 > 0 && 50 > Class113.anInt1552 && ~var4 != 0) {
