...
public final class PacketParser {
    ...
    static RSString aClass94_85 = RSString.parse("overlay");
            ...
            if (Unsorted.incomingOpcode == 115) {
                ...
                if (Unsorted.incomingOpcode == 70) {
                    ...
                    if (message.endsWith(TextCore.HasTradeRequest)) {
                        ...
                        if (!isIgnored && inTutorialIsland == 0) {
                            var41 = message.substring(1 + message.indexOf(Class155.char_colon, 101), message.length() + -9, (byte) -83 ^ -83);
                        ...
                        if (!isIgnored && inTutorialIsland == 0) {
                            var41 = message.substring(1 + message.indexOf(Class155.char_colon, 92), message.length() - 9, (byte) -83 ^ -83);
