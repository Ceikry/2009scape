...
final class Class3_Sub28_Sub2 extends Node {
   ...
   static void method535(byte var0, int var1) {
      try {
         Class151.aFloatArray1934[0] = (float) Unsorted.bitwiseAnd(255, var1 >> 16) / 255.0F;
         Class151.aFloatArray1934[1] = (float) Unsorted.bitwiseAnd(var1 >> 8, 255) / 255.0F;
         Class151.aFloatArray1934[2] = (float) Unsorted.bitwiseAnd(255, var1) / 255.0F;
   ...
   static Class75_Sub3 method536(RSByteBuffer var1) {
      try {
          ...
          return new Class75_Sub3(var1.getShort((byte)25), var1.getShort((byte)73), var1.getShort((byte)114), var1.getShort((byte)33), var1.getShort((byte)78), var1.getShort((byte)91), var1.getShort((byte)120), var1.getShort((byte)113), var1.getTriByte((byte)115), var1.readUnsignedByte());
      } catch (RuntimeException var3) {
