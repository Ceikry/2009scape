                                                            ...
                                                            if (opcode >= 4600) {
                                                                ...
                                                                if (5500 > opcode) {
                                                                    ...
                                                                    if (opcode == 5401) {
                                                                        ...
                                                                        ClearReferenceCache.method2265();
                                                                        ClearReferenceCache.method1076();
                                                                    ...
                                                                    if (opcode == 5421) {
                                                                        ...
                                                                        if (null == GameShell.frame && (!flag5 || Signlink.anInt1214 == 3 || !Signlink.osName.startsWith("win") || Class106.hasInternetExplorer6)) {
                                                                            ...
                                                                            UpdateLoop.aClass64_351 = Signlink.aClass87_665.method1452(new String(class94_64.method1568(), StandardCharsets.ISO_8859_1), true);
                                                                        }
                                                                        continue;
                                                                    }
                                                                    if (5422 == opcode) {
                                                                    ...
                                                                    if (opcode >= 6300) {
                                                                        ...
                                                                        if (opcode >= 6500) {
                                                                            ...
                                                                            if (opcode >= 6700)
                                                                                break;
                                                                            if (6600 == opcode) {
                                                                                UpdateLoop.aBoolean346 = ItemDefinition.intsStack[--iStackCounter] == 1;
                                                                                Class119.method1730(Signlink.aClass87_665);
                                                                                continue;
                                                                            }
                                                                            if (opcode != 6601)
                                                                                break;
                                                                            ItemDefinition.intsStack[iStackCounter++] = UpdateLoop.aBoolean346 ? 1 : 0;
                                                                            continue;
                                                                        }
                                                                        if (6405 == opcode) {
