            ...
            if (null != Signlink.aClass87_665.applet) {
                try {
                    ...
                    if (0 == var1.length()) {
                        ...
                        var4 = RSString.stringCombiner(new RSString[]{var4, TextCore.HasExpires, TimeUtils.date(94608000000L + TimeUtils.time()), TextCore.HasMaxAge, Class3_Sub28_Sub12.method612(94608000L)});
                    }
